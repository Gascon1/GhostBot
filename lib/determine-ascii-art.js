...
`}
    ...
    if (isDead) {
        monster = { "name": "ghost", "art": "     .-.\r\n   .\'   `.\r\n   :g g   :\r\n   : o    `.\r\n  :         ``.\r\n :             `.\r\n:  :         .   `.\r\n:   :          ` . `.\r\n `.. :            `. ``;\r\n    `:;             `:\'\r\n       :              `.\r\n        `.              `.     .\r\n          `\'`\'`\'`---..,___`;.-\' \r\n" }
    }
    if (!isDead) {
        if (hasRolledOne) {
            return { "flavor": 'You\'ve encountered a ' + monster.name + ' , time to fight!', "art": monster.art, "end": 'RUH ROH , you died :skull:' + '\r\n' + 'Odds were: ' + odds }
        }
        return { "flavor": 'You\'ve encountered a ' + monster.name + ' , time to fight!', "art": monster.art, "end": 'Congratulation , you\'ve vanquished your foe!' + '\r\n' + 'Odds were: ' + odds }
    }
    return { "flavor": 'You\'ve encountered a ' + monster.name + ' , time to fight!', "art": monster.art, "end": 'Congratulation , you\'ve vanquished your foe!' + '\r\n' + 'Odds were: ' + odds }
}
